<template>
  ...
  <header class="masthead">
    <div class="container px-4 px-lg-5 h-100 w-75">
      <div
        ...
        class="row gx-4 gx-lg-5 h-75 align-items-center justify-content-center"
      >
        ...
        <div class="col-lg-10 align-self-baseline">
          <RouterLink class="btn btn-primary btn-xl" to="course/0"
            >Join Us</RouterLink
          >
        </div>
      </div>
  ...
  <section class="page-section px-sm-3">
    <div class="container mybg-light">
      ...
      <Carousel v-bind="settings" :breakpoints="breakpoints">
        <Slide
          :id="'carousel' + coach.employeeid"
          v-for="coach in coachPics"
          :key="coach.employeeid"
          class="carousel slide col-lg-3 px-sm-4"
          data-bs-touch="false"
        ...
        >
          <div class="carousel-inner" style="height: 360px">
            <div
              class="carousel-item"
              style=""
              v-for="(pic, index) in coach.coachpic"
              :key="index"
              :class="{ active: index === 0 }"
            >
              <img
                style="width: 90%; height: 300px"
                :src="`data:image/jpeg;base64,${pic.cpicfile}`"
                alt="維修中"
              />
              <h4 style="margin: 0">{{ coach.employeenamne }}</h4>
              <p class="text-muted">
                專長:{{ coach.specialtyname
                }}<i class="bi bi-envelope m-2" :title="coach.employeeemail"></i
                ><i class="bi bi-telephone" :title="coach.emploueephone"></i>
              </p>
            </div>
          </div>
          <button
            class="carousel-control-prev m-5"
            type="button"
            :data-bs-target="'#carousel' + coach.employeeid"
            data-bs-slide="prev"
          >
          ...
          <button
            class="carousel-control-next m-5"
            type="button"
            :data-bs-target="'#carousel' + coach.employeeid"
            data-bs-slide="next"
          >
      ...
      <div class="container-fluid p-0">
        ...
        <div class="row g-0">
          <div class="col-lg-4 col-sm-6">
            <a
              class="portfolio-box"
              href="src/assets/index/classroom/攀岩教室.jpg"
          ...
          <div class="col-lg-4 col-sm-6">
            <a
              class="portfolio-box"
              href="src/assets/index/classroom/有氧大教室.jpg"
              title="有氧大教室"
            >
              <img
                class="img-fluid"
          ...
          <div class="col-lg-4 col-sm-6">
            <a
              class="portfolio-box"
              href="src/assets/index/classroom/有氧小教室.jpg"
              title="有氧小教室"
            >
              <img
                class="img-fluid"
                src="../assets/index/classroom/有氧小教室.jpg"
                alt="有氧小教室"
              />
              <div class="portfolio-box-caption">
                <div class="project-category text-white-50">Category</div>
          ...
          <div class="col-lg-4 col-sm-6">
            <a
              class="portfolio-box"
              href="src/assets/index/classroom/格鬥教室.jpg"
              title="格鬥教室"
            >
              <img
                class="img-fluid"
                src="../assets/index/classroom/格鬥教室.jpg"
                alt="格鬥教室"
              />
              <div class="portfolio-box-caption">
                <div class="project-category text-white-50">Category</div>
          ...
          <div class="col-lg-4 col-sm-6">
            <a
              class="portfolio-box"
              href="src/assets/index/classroom/空中瑜珈.jpg"
              title="空中瑜珈"
            >
              <img
                class="img-fluid"
          ...
          <div class="col-lg-4 col-sm-6">
            <a
              class="portfolio-box"
              href="src/assets/index/classroom/飛輪教室.jpg"
              title="飛輪教室"
            >
              <img
                class="img-fluid"
                src="../assets/index/classroom/飛輪教室.jpg"
                alt="飛輪教室"
              />
    ...
    <div class="container px-4 text-center mybg-light">
      ...
      <div class="row gx-4 gx-lg-5">
        <div
          ...
          v-for="(activity, activityindex) in activitys"
          :key="activityindex"
        >
          <img
            :src="activity.activitypic"
            style="width: 80%; height: 300px; cursor: pointer"
            alt="維修中"
    ...
    <div class="container px-4 px-lg-5">
      <div class="row gx-4 gx-lg-5 justify-content-center">
        <div class="col-lg-6 col-xl-6">
          <!-- GoogleMap -->
          <GoogleMap
            api-key="AIzaSyB3Hjtldwb3Ep_QOvoCs1UZAtkmWNDCJyA"
  ...
  <button ref="mybutton" class="btn btn-primary" id="btn-back-to-top">
    TOP
  </button>
</template>
